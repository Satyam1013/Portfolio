...
import { SiDocker, SiJavascript, SiNodedotjs } from "react-icons/si";
    ...
    <div className="bg-[#0F1113] text-white py-20 flex items-center justify-center px-4 sm:px-8">
      <div className="w-[92%] max-w-6xl mx-auto bg-transparent">
        ...
        <div className="flex flex-col gap-6">
          <motion.div
            className="bg-cardColor rounded-lg shadow-lg p-4 sm:p-6 transition-transform transform hover:-translate-y-2 hover:shadow-xl"
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-center">
                <SiDocker className="text-designColor mr-2 text-xl sm:text-2xl" />
                <h2 className="text-lg sm:text-xl font-semibold">
                  Full-stack Developer Freelance
                </h2>
              </div>
              <div className="text-sm sm:text-base text-right">
                <p className="font-semibold">Local | International Clients</p>
                <p className="flex items-center justify-end">
                  <FaClock className="mr-1" /> 2021 - Present
                </p>
              </div>
            </div>
          </motion.div>
